...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", (e) => {
    ...
    const idEmpleado = (document.getElementById("idEmpleado") as HTMLInputElement).value.trim()
    ...
    const usuario = usuarios.find((u: any) => u.idEmpleado === idEmpleado && u.password === password)
